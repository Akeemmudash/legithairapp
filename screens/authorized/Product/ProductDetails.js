        ...
        <View>
          ...
          <ScrollView>
            <View style={styles.imageContainer}>
              <Image
                source={{ uri: displayImage?.filename }}
              ...
              {product.images.map((image, index) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    image.filename === (selectedImage && selectedImage.filename)
      ...
      <View style={[styles.detailsContainer, { paddingBottom: insets.bottom }]}>
        ...
        >
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity
              style={[
                ...
                !selectedInch &&
                  isInchAvailable && { backgroundColor: Colors.Gray_03 },
              ]}
              activeOpacity={0.6}
          ...
          <Text style={styles.descriptionText}>
            {translate(product.product_description)}
          </Text>
        </ScrollView>
      </View>
